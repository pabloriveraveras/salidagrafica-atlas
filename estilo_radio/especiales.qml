...
<qgis simplifyDrawingHints="1" minScale="1e+08" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyMaxScale="1" labelsEnabled="1" styleCategories="AllStyleCategories" version="3.10.7-A Coruña" maxScale="0" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyLocal="1">
  ...
  <renderer-v2 forceraster="0" enableorderby="1" symbollevels="0" type="RuleRenderer">
    <rules key="{4757d8cf-dd23-48d7-bdfb-72f3bcb79d02}">
      <rule filter="(&quot;codigo20&quot;  not in (99900,99910, 99915, 99920, 99925, 99930, 99932, 99945 , 99946, 99947, 99948, 99949, 99950, 99951, 99952, 99955, 99965, 99966, 99967, 99968, 99970, 99971, 99972, 99973, 99974, 99975, 99980 ))" symbol="0" key="{50bc421e-ae32-439d-884f-40ae093255fb}">
        <rule filter="(&quot;codigo20&quot;  not in (99900,99910, 99915, 99920, 99925, 99930, 99932, 99945 , 99946, 99947, 99948, 99949, 99950, 99951, 99952, 99955, 99965, 99966, 99967, 99968, 99970, 99971, 99972, 99973, 99974, 99975, 99980 ))&#xd;&#xa;" symbol="1" key="{19b84d3d-0bb8-4116-bfaa-60916da109a6}" label="calles"/>
      </rule>
      <rule key="{fd605965-43a5-468c-892f-8396fdb87ccb}">
        <rule filter="&quot;codigo20&quot; in (99950, 99951, 99952)&#xd;&#xa;" symbol="2" key="{4a658f89-12d6-4c41-8b11-6a24b87ef895}" label="lineas alambrado"/>
        <rule filter="(&quot;codigo20&quot;   in (99900,99910, 99915, 99920, 99925, 99930))&#xd;&#xa;&#xd;&#xa;  " symbol="3" key="{3c9218fe-60f0-443c-b0fe-562aebcea2d6}" label="ferrocarril"/>
        <rule filter="(&quot;codigo20&quot;  in ( 99932, 99945 , 99946, 99947, 99948, 99949, 99955, 99965, 99966, 99967, 99968, 99970, 99971, 99972, 99973, 99974, 99975, 99980 ))&#xd;&#xa;&#xd;&#xa;" symbol="4" key="{248b9762-227a-4b55-a519-1f3f001cc02e}" label="otros"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="line" name="2">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="marker" name="@2@1">
    ...
    <rules key="{853a9b72-6b4d-49ea-887a-e6640c2ecd3e}">
      <rule filter=" intersects( point_on_surface ($geometry ), @atlas_geometry )" key="{834c35b4-932f-43b0-b396-ffe42637b0eb}" scalemindenom="10" scalemaxdenom="3000">
        <settings calloutType="simple">
          ...
          <placement offsetType="0" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" placement="3" offsetUnits="MM" placementFlags="9" yOffset="0" rotationAngle="0" quadOffset="4" repeatDistanceUnits="MM" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" distUnits="RenderMetersInMapUnits" repeatDistance="0" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" dist="0" centroidWhole="0" geometryGenerator="" fitInPolygonOnly="0" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" layerType="LineGeometry" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering obstacleType="0" limitNumLabels="1" scaleMax="10000" scaleVisibility="1" scaleMin="500" fontLimitPixelSize="0" drawLabels="1" zIndex="0" fontMaxPixelSize="10000" displayAll="0" labelPerPart="0" minFeatureSize="0" maxNumLabels="2000" upsidedownLabels="0" obstacleFactor="1" obstacle="0" mergeLines="1" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option type="Map" name="properties">
      ...
      <rule filter=" intersects( point_on_surface ($geometry ), @atlas_geometry )" key="{694ca366-9dcc-4673-8b8a-5c1999aad7dc}" scalemindenom="3000" scalemaxdenom="8000">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontUnderline="0" fontSize="6" textColor="13,0,0,255" fontWeight="50" fontSizeUnit="Point" fontLetterSpacing="0" fontKerning="1" useSubstitutions="0" fontItalic="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.5" fieldName="codinomb" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontStrikeout="0" textOpacity="1" fontWordSpacing="0" blendMode="0" namedStyle="Normal" fontCapitals="0">
            <text-buffer bufferColor="255,255,255,255" bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferSize="1"/>
            <background shapeDraw="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeType="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeSVGFile="" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeOffsetUnit="MM" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeOffsetY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiX="0" shapeSizeX="0" shapeRadiiUnit="MM" shapeSizeY="0">
              <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="marker" name="markerSymbol">
                <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
          ...
          <text-format multilineAlign="4294967295" placeDirectionSymbol="0" plussign="0" addDirectionSymbol="0" reverseDirectionSymbol="0" autoWrapLength="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" formatNumbers="0" useMaxLineLengthForAutoWrap="1" wrapChar="" decimals="3"/>
          <placement offsetType="0" priority="5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" xOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" placement="3" offsetUnits="MM" placementFlags="9" yOffset="0" rotationAngle="0" quadOffset="4" repeatDistanceUnits="MM" preserveRotation="1" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" centroidInside="0" distUnits="RenderMetersInMapUnits" repeatDistance="0" geometryGeneratorEnabled="0" distMapUnitScale="3x:0,0,0,0,0,0" maxCurvedCharAngleOut="-25" dist="0" centroidWhole="0" geometryGenerator="" fitInPolygonOnly="0" overrunDistanceUnit="MM" geometryGeneratorType="PointGeometry" layerType="LineGeometry" maxCurvedCharAngleIn="25" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
          <rendering obstacleType="0" limitNumLabels="0" scaleMax="10000" scaleVisibility="1" scaleMin="3001" fontLimitPixelSize="0" drawLabels="1" zIndex="0" fontMaxPixelSize="10000" displayAll="0" labelPerPart="0" minFeatureSize="0" maxNumLabels="0" upsidedownLabels="0" obstacleFactor="1" obstacle="0" mergeLines="1" fontMinPixelSize="3"/>
          <dd_properties>
            <Option type="Map">
              <Option value="" type="QString" name="name"/>
              <Option type="Map" name="properties">
      ...
      <rule filter=" intersects( point_on_surface ($geometry ), @atlas_geometry )" key="{cd7a4aa0-d85b-4966-8f2a-eb5d9898a935}" scalemindenom="8000" scalemaxdenom="100000000">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontUnderline="0" fontSize="3" textColor="13,0,0,255" fontWeight="50" fontSizeUnit="Point" fontLetterSpacing="0" fontKerning="1" useSubstitutions="0" fontItalic="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.5" fieldName="codinomb" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontStrikeout="0" textOpacity="1" fontWordSpacing="0" blendMode="0" namedStyle="Normal" fontCapitals="0">
            <text-buffer bufferColor="255,255,255,255" bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferSize="1"/>
            <background shapeDraw="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeType="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeSVGFile="" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeOffsetUnit="MM" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeOffsetY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiX="0" shapeSizeX="0" shapeRadiiUnit="MM" shapeSizeY="0">
              <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="marker" name="markerSymbol">
                <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
      ...
      <rule active="0" filter="not  intersects( point_on_surface ($geometry ), @atlas_geometry )" description="fuera" key="{ea062b13-e023-4ef2-b01f-7168ac713ae7}" scalemindenom="8000" scalemaxdenom="100000000">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontUnderline="0" fontSize="3" textColor="178,178,178,255" fontWeight="50" fontSizeUnit="Point" fontLetterSpacing="0" fontKerning="1" useSubstitutions="0" fontItalic="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.5" fieldName="codinomb" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontStrikeout="0" textOpacity="1" fontWordSpacing="0" blendMode="0" namedStyle="Normal" fontCapitals="0">
            <text-buffer bufferColor="255,255,255,255" bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferSize="1"/>
            <background shapeDraw="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeType="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeSVGFile="" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeOffsetUnit="MM" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeOffsetY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiX="0" shapeSizeX="0" shapeRadiiUnit="MM" shapeSizeY="0">
              <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="marker" name="markerSymbol">
                <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
      ...
      <rule active="0" filter=" not intersects( point_on_surface ($geometry ), @atlas_geometry )" description="fuera" key="{083f38de-1c9b-4bb4-ab2d-f035df7c1d3a}" scalemindenom="3000" scalemaxdenom="8000">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontUnderline="0" fontSize="6" textColor="178,178,178,255" fontWeight="50" fontSizeUnit="Point" fontLetterSpacing="0" fontKerning="1" useSubstitutions="0" fontItalic="0" previewBkgrdColor="255,255,255,255" multilineHeight="0.5" fieldName="codinomb" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontStrikeout="0" textOpacity="1" fontWordSpacing="0" blendMode="0" namedStyle="Normal" fontCapitals="0">
            <text-buffer bufferColor="255,255,255,255" bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferSize="1"/>
            <background shapeDraw="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeType="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeSVGFile="" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeOffsetUnit="MM" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeOffsetY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiX="0" shapeSizeX="0" shapeRadiiUnit="MM" shapeSizeY="0">
              <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="marker" name="markerSymbol">
                <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
      ...
      <rule active="0" filter="not  intersects( point_on_surface ($geometry ), @atlas_geometry )" description="fuera" key="{5e1dcdc2-9250-44aa-a19a-52c00863fac0}" scalemindenom="10" scalemaxdenom="3000">
        <settings calloutType="simple">
          <text-style textOrientation="horizontal" fontUnderline="0" fontSize="12" textColor="178,178,178,255" fontWeight="50" fontSizeUnit="Point" fontLetterSpacing="0" fontKerning="1" useSubstitutions="0" fontItalic="0" previewBkgrdColor="255,255,255,255" multilineHeight="1" fieldName="codinomb" isExpression="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontFamily="Arial" fontStrikeout="0" textOpacity="1" fontWordSpacing="0" blendMode="0" namedStyle="Normal" fontCapitals="0">
            <text-buffer bufferColor="255,255,255,255" bufferDraw="0" bufferOpacity="1" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferNoFill="1" bufferBlendMode="0" bufferSizeUnits="MM" bufferSize="1"/>
            <background shapeDraw="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeType="0" shapeBorderColor="128,128,128,255" shapeSizeUnit="MM" shapeSVGFile="" shapeJoinStyle="64" shapeFillColor="255,255,255,255" shapeOpacity="1" shapeOffsetUnit="MM" shapeBorderWidthUnit="MM" shapeRotationType="0" shapeOffsetY="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiY="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeBlendMode="0" shapeOffsetX="0" shapeRadiiX="0" shapeSizeX="0" shapeRadiiUnit="MM" shapeSizeY="0">
              <symbol clip_to_extent="1" force_rhr="0" alpha="1" type="marker" name="markerSymbol">
                <layer class="SimpleMarker" enabled="1" locked="0" pass="0">
