...
<qgis simplifyLocal="1" maxScale="0" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" minScale="1e+08" labelsEnabled="1" simplifyDrawingTol="1" version="3.10.12-A Coruña" simplifyDrawingHints="1">
  <flags>
  ...
  <labeling type="rule-based">
    <rules key="{67c4f171-ec74-4bb8-8e1f-e4712e951b53}">
      <rule filter="$id =  @atlas_featureid " key="{7a0fda41-17af-4f86-8181-6eb4deccec6e}">
