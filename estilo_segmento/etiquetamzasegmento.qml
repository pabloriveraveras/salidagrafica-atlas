...
<qgis simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" styleCategories="AllStyleCategories" maxScale="0" minScale="100000000" labelsEnabled="1" version="3.12.1-București" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1">
  <flags>
  ...
  <labeling type="rule-based">
    <rules key="{74367047-bdec-42bd-b556-e1d32ec95b8a}">
      <rule scalemindenom="4001" filter="&#xd;&#xa;radio = attribute(@atlas_feature, 'radio')&#xd;&#xa;" key="{48065f85-ab5d-4705-9a81-786c5b8abe19}" scalemaxdenom="100000">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontWeight="75" fontKerning="1" fontWordSpacing="0" fieldName="mza" fontCapitals="0" fontUnderline="0" textOpacity="1" fontSizeUnit="Point" fontSize="5" multilineHeight="1" isExpression="0" fontFamily="Arial" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" namedStyle="Bold" useSubstitutions="0" textOrientation="horizontal" fontStrikeout="0" textColor="0,0,0,255" blendMode="0">
            <text-buffer bufferColor="255,255,255,255" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferBlendMode="0" bufferSize="1" bufferJoinStyle="128"/>
            <text-mask maskEnabled="0" maskOpacity="1" maskType="0" maskedSymbolLayers="" maskJoinStyle="128" maskSize="0" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRotationType="0" shapeType="0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeSizeUnit="MM" shapeSizeX="0" shapeBorderWidth="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeBlendMode="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeBorderColor="128,128,128,255" shapeOpacity="1" shapeSVGFile="" shapeSizeY="0" shapeRadiiY="0" shapeSizeType="0" shapeOffsetX="0" shapeFillColor="255,255,255,255"/>
            <shadow shadowRadiusUnit="MM" shadowRadiusAlphaOnly="0" shadowOffsetGlobal="1" shadowOffsetUnit="MM" shadowUnder="0" shadowOffsetAngle="135" shadowDraw="0" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowOffsetDist="1" shadowBlendMode="6" shadowRadius="0" shadowOpacity="0"/>
            <dd_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
          ...
          <text-format decimals="3" placeDirectionSymbol="0" formatNumbers="0" autoWrapLength="0" leftDirectionSymbol="&lt;" plussign="0" rightDirectionSymbol=">" reverseDirectionSymbol="0" useMaxLineLengthForAutoWrap="1" addDirectionSymbol="0" wrapChar="" multilineAlign="3"/>
          <placement maxCurvedCharAngleOut="-25" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" distMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" geometryGenerator="" xOffset="0" offsetType="0" distUnits="MM" layerType="UnknownGeometry" rotationAngle="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" placement="1" geometryGeneratorType="PointGeometry" fitInPolygonOnly="0" repeatDistance="0" centroidInside="0" dist="0" placementFlags="10" preserveRotation="1" yOffset="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" quadOffset="4" offsetUnits="MM" centroidWhole="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5" geometryGeneratorEnabled="0" repeatDistanceUnits="MM"/>
          <rendering scaleMax="5000" mergeLines="0" obstacleType="0" fontMinPixelSize="3" fontMaxPixelSize="10000" limitNumLabels="0" drawLabels="1" obstacleFactor="1" scaleMin="200" maxNumLabels="2000" upsidedownLabels="0" zIndex="0" labelPerPart="0" scaleVisibility="0" minFeatureSize="0" displayAll="1" fontLimitPixelSize="0" obstacle="1"/>
          <dd_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
              <Option name="properties"/>
      ...
      <rule scalemindenom="100" filter="&#xd;&#xa;radio = attribute(@atlas_feature, 'radio')&#xd;&#xa;" key="{3c3034bc-363a-418b-a117-2776ea907012}" scalemaxdenom="4000">
        <settings calloutType="simple">
          <text-style fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontItalic="0" fontWeight="75" fontKerning="1" fontWordSpacing="0" fieldName="mza" fontCapitals="0" fontUnderline="0" textOpacity="1" fontSizeUnit="Point" fontSize="10" multilineHeight="1" isExpression="0" fontFamily="Arial" fontLetterSpacing="0" previewBkgrdColor="255,255,255,255" namedStyle="Bold" useSubstitutions="0" textOrientation="horizontal" fontStrikeout="0" textColor="0,0,0,255" blendMode="0">
            <text-buffer bufferColor="255,255,255,255" bufferOpacity="1" bufferDraw="0" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferBlendMode="0" bufferSize="1" bufferJoinStyle="128"/>
            <text-mask maskEnabled="0" maskOpacity="1" maskType="0" maskedSymbolLayers="" maskJoinStyle="128" maskSize="0" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
            <background shapeRotationType="0" shapeType="0" shapeOffsetY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeSizeUnit="MM" shapeSizeX="0" shapeBorderWidth="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeRotation="0" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeBlendMode="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeBorderColor="128,128,128,255" shapeOpacity="1" shapeSVGFile="" shapeSizeY="0" shapeRadiiY="0" shapeSizeType="0" shapeOffsetX="0" shapeFillColor="255,255,255,255"/>
            <shadow shadowRadiusUnit="MM" shadowRadiusAlphaOnly="0" shadowOffsetGlobal="1" shadowOffsetUnit="MM" shadowUnder="0" shadowOffsetAngle="135" shadowDraw="0" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowColor="0,0,0,255" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowScale="100" shadowOffsetDist="1" shadowBlendMode="6" shadowRadius="0" shadowOpacity="0"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory minimumSize="0" height="15" lineSizeType="MM" scaleDependency="Area" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" backgroundAlpha="255" minScaleDenominator="0" rotationOffset="270" penAlpha="255" sizeType="MM" penColor="#000000" spacingUnit="MM" backgroundColor="#ffffff" width="15" spacingUnitScale="3x:0,0,0,0,0,0" direction="1" showAxis="0" diagramOrientation="Up" scaleBasedVisibility="0" enabled="0" barWidth="5" lineSizeScale="3x:0,0,0,0,0,0" opacity="1" spacing="0" maxScaleDenominator="1e+08" penWidth="0">
  ...
  <DiagramLayerSettings placement="0" obstacle="0" dist="0" priority="0" zIndex="0" linePlacementFlags="18" showAll="1">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" field="e0531_" index="5"/>
    <alias name="" field="e0531_id" index="6"/>
    ...
    <alias name="" field="cen91" index="16"/>
    <alias name="" field="tmza" index="17"/>
    <alias name="" field="cen99" index="18"/>
    <alias name="" field="fracn" index="19"/>
    <alias name="" field="radion" index="20"/>
    <alias name="" field="frac01" index="21"/>
    <alias name="" field="radio01" index="22"/>
    <alias name="" field="mza01" index="23"/>
    <alias name="" field="df" index="24"/>
    <alias name="" field="tfrac" index="25"/>
    <alias name="" field="dfr" index="26"/>
    <alias name="" field="tradio" index="27"/>
    <alias name="" field="dfrm" index="28"/>
    <alias name="" field="alink" index="29"/>
    <alias name="" field="alink2" index="30"/>
    <alias name="" field="node_id_postgis" index="31"/>
    <alias name="" field="face_id_postgis" index="32"/>
  </aliases>
  ...
  <defaults>
    ...
    <default expression="" field="cen99" applyOnUpdate="0"/>
    <default expression="" field="fracn" applyOnUpdate="0"/>
    <default expression="" field="radion" applyOnUpdate="0"/>
    <default expression="" field="frac01" applyOnUpdate="0"/>
    <default expression="" field="radio01" applyOnUpdate="0"/>
    <default expression="" field="mza01" applyOnUpdate="0"/>
    <default expression="" field="df" applyOnUpdate="0"/>
    <default expression="" field="tfrac" applyOnUpdate="0"/>
    <default expression="" field="dfr" applyOnUpdate="0"/>
    <default expression="" field="tradio" applyOnUpdate="0"/>
    <default expression="" field="dfrm" applyOnUpdate="0"/>
    <default expression="" field="alink" applyOnUpdate="0"/>
    <default expression="" field="alink2" applyOnUpdate="0"/>
    <default expression="" field="node_id_postgis" applyOnUpdate="0"/>
    <default expression="" field="face_id_postgis" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint constraints="3" unique_strength="1" field="ogc_fid" notnull_strength="1" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="valueid" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="polyid" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="area" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="perimeter" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="e0531_" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="e0531_id" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="nommuni" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="nomloc" notnull_strength="0" exp_strength="0"/>
    ...
    <constraint constraints="0" unique_strength="0" field="mza" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="mzatxt" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="cen91" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="tmza" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="cen99" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="fracn" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="radion" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="frac01" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="radio01" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="mza01" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="df" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="tfrac" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="dfr" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="tradio" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="dfrm" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="alink" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="alink2" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="node_id_postgis" notnull_strength="0" exp_strength="0"/>
    <constraint constraints="0" unique_strength="0" field="face_id_postgis" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="e0531_" exp="" desc=""/>
    <constraint field="e0531_id" exp="" desc=""/>
    ...
    <constraint field="fracn" exp="" desc=""/>
    <constraint field="radion" exp="" desc=""/>
    <constraint field="frac01" exp="" desc=""/>
    <constraint field="radio01" exp="" desc=""/>
    <constraint field="mza01" exp="" desc=""/>
    <constraint field="df" exp="" desc=""/>
    <constraint field="tfrac" exp="" desc=""/>
    <constraint field="dfr" exp="" desc=""/>
    <constraint field="tradio" exp="" desc=""/>
    <constraint field="dfrm" exp="" desc=""/>
    <constraint field="alink" exp="" desc=""/>
    <constraint field="alink2" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;mza&quot;" sortOrder="0">
    <columns>
      ...
      <column name="e0531_" type="field" width="-1" hidden="0"/>
      <column name="e0531_id" type="field" width="-1" hidden="0"/>
      <column name="cen91" type="field" width="-1" hidden="0"/>
      <column name="tmza" type="field" width="-1" hidden="0"/>
      <column name="cen99" type="field" width="-1" hidden="0"/>
      <column name="fracn" type="field" width="-1" hidden="0"/>
      <column name="radion" type="field" width="-1" hidden="0"/>
      <column name="frac01" type="field" width="-1" hidden="0"/>
      <column name="radio01" type="field" width="-1" hidden="0"/>
      <column name="mza01" type="field" width="-1" hidden="0"/>
      <column name="df" type="field" width="-1" hidden="0"/>
      <column name="tfrac" type="field" width="-1" hidden="0"/>
      <column name="dfr" type="field" width="-1" hidden="0"/>
      <column name="tradio" type="field" width="-1" hidden="0"/>
      <column name="dfrm" type="field" width="-1" hidden="0"/>
      <column name="alink" type="field" width="-1" hidden="0"/>
      <column name="alink2" type="field" width="-1" hidden="0"/>
      <column name="node_id_postgis" type="field" width="-1" hidden="0"/>
      <column name="face_id_postgis" type="field" width="-1" hidden="0"/>
    </columns>
